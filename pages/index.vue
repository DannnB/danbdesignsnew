<template>
  <div class="home">
      ...
      <b-container>
        <b-row>
          <b-col>
            ...
            <p class="intro-content" style="display:none;">Highly experienced and creative web engineer. With a keen interest in technology, mobile applications and user experience. Being self-taught I take authority of my own personal development. This means I regularly update my skills and enjoy a challenge. This has allowed me to accomplish a strong background in JavaScript (Frontend/Backend), HTML, CSS(SCSS), Accessibility and SEO practices. Passionate about all things digital, clean reusable code and developing the best services and products.</p>
          </b-col>
        </b-row>
      </b-container>
    </div>
    ...
    <b-container>
      <b-row class="blog-header" style="display: none;">
        <b-col>
          <h2>Blog</h2>
        </b-col>
      </b-row>
